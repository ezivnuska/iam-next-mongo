// app/ui/poker/player-controls-vertical.tsx
...
interface PlayerControlsVerticalProps {
  onActionTaken?: () => void;
}

function PlayerControlsVertical({ onActionTaken }: PlayerControlsVerticalProps = {}) {
...
export default memo(PlayerControlsVertical);
