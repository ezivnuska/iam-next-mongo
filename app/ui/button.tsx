...
export function Button({
  ...
  const buttonClass = clsx(
    'flex flex-row flex-nowrap items-center justify-center cursor-pointer rounded-lg font-medium transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 aria-disabled:cursor-not-allowed aria-disabled:opacity-50',
    sizeClasses[size],
